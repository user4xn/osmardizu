<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Member Outsorcing Umum</h1>
...
$(document).ready(function(){
    ...
    function loadTable(pagno){
       ...
       $.ajax({
         url: '<?=base_url()?>AdminArea/jsonUMUM/'+pagno,
         type: 'get',
       ...
       for(index in result){
          ...
          sno++;
            ...
            var tr = "<div class='row p-1 mb-2'>"
                ...
                tr += "<div class='col text-right'><button class='btn btn-primary btn-sm p-0 pl-1 pr-1' data-toggle='modal' data-target='#detail"+id_member+"'>Detail</button></div>"
                tr += "</div>"
