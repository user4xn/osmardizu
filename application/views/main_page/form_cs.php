...
<div class="container col-md-7">
	<form method="POST" action="<?= site_url('p/act_cs') ?>" enctype="multipart/form-data">
	<div class="row" style="margin-top: -100px;">
			<div class="card w-100" style="border-radius: 0px;background-color: #212529;">
				<div class="card-body text-center">
					<div class="text-left text-light"><h2 style="font-family: Montserrat;"><b style="background: -webkit-linear-gradient(#00d2ff,#3a7bd5);-webkit-background-clip: text;-webkit-text-fill-color: transparent;">Form</b> Cleaning Service</h2></div>
				</div>
			</div>
	...
	<div id="field_docMultiple">
		<div class="row mt-3">
			<div class="card w-100">
				<div class="card-body">
					<div class="card-title"> Sertifikat Parklaring</div><hr>
					<div class="mb-3">
  						  <input class="form-control" type="file" onchange='ValidateSingleInput(this)' name="sk_paklaring" required>
