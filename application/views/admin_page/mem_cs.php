<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Member CS</h1>
...
function openDoc(a){
    var uid = a.getAttribute('data-namefile');
    swal.fire({
        html: "<embed src='<?= base_url()?>/assets/uploads/"+uid+"' frameborder='0' width='100%' height='500px'>",
...
$(document).ready(function(){
    ...
    function loadTable(pagno){
       ...
       $.ajax({
         url: '<?=base_url()?>AdminArea/jsonCSM/'+pagno,
         type: 'get',
    ...
    function setData(result,sno){
       ...
       for(index in result){
          ...
          var sertifikat_paklaring  = result[index].sertifikat_paklaring;
          ...
          sno++;
            ...
            var tr = "<div class='row p-1 mb-2'>"
                ...
                tr += "<div class='col text-right'><button class='btn btn-primary btn-sm p-0 pl-1 pr-1' data-toggle='modal' data-target='#detail"+id_member+"'>Detail</button> <button class='btn btn-danger btn-sm p-0 pl-1 pr-1' data-namefile = '"+sertifikat_paklaring+"' onclick='openDoc(this)'>Sertifikat Parklaring</button></div>"
                tr += "</div>"
